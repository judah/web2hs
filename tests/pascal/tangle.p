...
out_buf_size=144;stack_size=50;max_id_length=12;unambig_length=7;
...
goto 20;end;
5:{104:}begin if(t=3)or({105:}((t=2)and(v=3)and(((out_contrib[1]=68)and(
out_contrib[2]=73)and(out_contrib[3]=86))or((out_contrib[1]=77)and(
out_contrib[2]=79)and(out_contrib[3]=68))))or((t=0)and((v=42)or(v=47)))
...
break_ptr+4)and(out_buf[break_ptr]=32))then if((out_buf[out_ptr-3]=68)
and(out_buf[out_ptr-2]=73)and(out_buf[out_ptr-1]=86))or((out_buf[out_ptr
-3]=77)and(out_buf[out_ptr-2]=79)and(out_buf[out_ptr-1]=68))then goto
666{:110};out_sign:=32;out_state:=3;out_val:=v;break_ptr:=out_ptr;
last_sign:=+1;end;
...
87,88,89,90:begin out_contrib[1]:=cur_char;send_out(2,1);end;
97,98,99,100,101,102,103,104,105,106,107,108,109,110,111,112,113,114,115
,116,117,118,119,120,121,122:begin out_contrib[1]:=cur_char-32;
...
if out_contrib[k]>=97 then out_contrib[k]:=out_contrib[k]-32 else if
out_contrib[k]=95 then k:=k-1;end;send_out(2,k);end;
...
{114:}4:begin out_contrib[1]:=65;out_contrib[2]:=78;out_contrib[3]:=68;
send_out(2,3);end;5:begin out_contrib[1]:=78;out_contrib[2]:=79;
out_contrib[3]:=84;send_out(2,3);end;6:begin out_contrib[1]:=73;
out_contrib[2]:=78;send_out(2,2);end;31:begin out_contrib[1]:=79;
out_contrib[2]:=82;send_out(2,2);end;24:begin out_contrib[1]:=58;
out_contrib[2]:=61;send_out(1,2);end;26:begin out_contrib[1]:=60;
out_contrib[2]:=62;send_out(1,2);end;28:begin out_contrib[1]:=60;
out_contrib[2]:=61;send_out(1,2);end;29:begin out_contrib[1]:=62;
out_contrib[2]:=61;send_out(1,2);end;30:begin out_contrib[1]:=61;
out_contrib[2]:=61;send_out(1,2);end;32:begin out_contrib[1]:=46;
out_contrib[2]:=46;send_out(1,2);end;{:114}39:{117:}begin k:=1;
out_contrib[1]:=39;repeat if k<line_length then k:=k+1;
out_contrib[k]:=get_output;until(out_contrib[k]=39)or(stack_ptr=0);
